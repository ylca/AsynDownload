...
namespace AltoHttp
{
    ...
    public class HttpDownloader : IDownloader
    {
        #region Variables
        /// <summary>
        /// Occurs when the download process is completed  下载完成事件
        /// </summary>
        public event EventHandler DownloadCompleted;
        /// <summary>
        /// Occurs when the download process is cancelled   下载取消事件
        /// </summary>
        public event EventHandler DownloadCancelled;
        /// <summary>
        /// Occurs when the download progress is changed    下载进度事件
        /// </summary>
        ...
        /// <summary>
        /// Pauses the download process 暂停
        /// </summary>
        public void Pause()
        {
            if (!acceptRange)
